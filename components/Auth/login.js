            ...
            <div className="w-[330px] p-6 space-y-2 sm:p-8">
                <form className="space-y-4 md:space-y-6">
                    <div>
                        ...
                        <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="name@company.com" required="" />
                    </div>
                    <div>
