            ...
            <div className="p-6 space-y-2 sm:p-8">
                <form className="space-y-4 md:space-y-6">
                    ...
                    <div className="flex justify-center">
                        <Link href='/app/home' className="w-[70%] text-white bg-[#419a00] hover:bg-[#419a00] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded text-sm px-5 py-2.5 text-center dark:bg-[#419a00] dark:hover:bg-[#419a00] dark:focus:ring-primary-800">
                           Login
                        </Link>
                        {/* <button type="submit" className="w-[70%] text-white bg-[#419a00] hover:bg-[#419a00] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded text-sm px-5 py-2.5 text-center dark:bg-[#419a00] dark:hover:bg-[#419a00] dark:focus:ring-primary-800">Login</button> */}
