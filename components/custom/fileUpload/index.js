    ...
    return (
        <div className='w-full flex items-center justify-start h-full'>
            <div className="my-2 h-full w-full">
                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-38 border-2 border-primary border-dashed rounded-lg cursor-pointer bg-primary hover:bg-primary">
