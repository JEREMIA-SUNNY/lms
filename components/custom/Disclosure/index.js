...
const Disclosure = () => {
    return (
        <section className="w-screen h-screen pt-20">
            <details open className="w-96 bg-white p-4 rounded-xl shadow-md group mx-auto overflow-hidden max-h-[56px] open:!max-h-[400px] transition-[max-height] duration-500 overflow-hidden">
                <summary
