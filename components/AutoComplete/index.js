            ...
            <Combobox value={selected} onChange={setSelected}>
                <div className="relative mt-1">
                    <div className="relative w-full">
                        ...
                        <Combobox.Input
                            className="shadow-lg bg-gray-50 border border-gray-300 text-textSecondary text-sm rounded-lg focus:ring-[#419a00] focus:border-[#419a00] block w-full pl-10 p-2.5"
                            ...
                            {filteredPeople.length === 0 && query !== '' ? (
                                ...
                                filteredPeople.map((person) => (
                                    ...
                                    >
                                        {({ selected, active }) => (
                                            <>
                                                <span  className={`cursor-pointer block truncate ${selected ? 'font-medium' : 'font-normal'}`}>
                                                    {person[keyname]}
                                                </span>
                                            </>
                                        )}
