            ...
            <Combobox value={selected} onChange={setSelected}>
                <div className="relative mt-1">
                    <div className="relative w-full">
                        ...
                        <Combobox.Input
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#419a00] focus:border-[#419a00] block w-full pl-10 p-2.5" placeholder="Search" required displayValue={(person) => person?.name}
