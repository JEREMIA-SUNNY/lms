...
const Training = ({ item }) => {
    const { id, auther, price, thumnnail, complete, description, modules, level, name , language} = item
    return (
        <Link className="p-4 rounded-lg shadow-xl bg-white  w-full transition ease-in-out delay-0 hover:-translate-2 hover:shadow-lg hover:scale-110 duration-300 " href={`/app/learning/trainings/detail/${id}`}>
            <div className="w-full">
                ...
                <div className="flex justify-between divide-x my-2">
                    <div className="mx-2 flex justify-center items-center rounded-lg bg-gray-100 px-2 py-1 flex text-gray-500 font-normal text">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-[#409a00]">
                    ...
                    <div className="mr-2 flex justify-center items-center rounded-lg bg-gray-100 px-2 py-1 flex text-gray-500 font-normal text">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-[#409a00]">
