...
const TrainingBatch = ({ id }) => {
    return (
        <div className="mt-4">
            <details className="w-full bg-white p-4 shadow bg-[#F5F5F5] rounded  group mx-auto overflow-hidden transition-[max-height] duration-800 overflow-hidden">
                <summary
                    ...
                    <div className="w-full ml-8">
                        <div className="w-full flex justify-between items-center">
                            ...
                            <div className="flex justify-start items-center">
                                <IconWithChip className='mr-3 w-24 h-10 bg-white shadow text-[#419a00] rounded-full text-sm py-1 px-2 mr-1'>
                                ...
                                <IconButton className='mr-3 w-24 px-2 h-10 bg-[#419a00] text-white shadow rounded-full text-sm py-1 px-2 mr-1 flex justify-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-2">
                ...
                <div className="py-4 -m-4 -mt-2 p-4 bg-gray-50">
