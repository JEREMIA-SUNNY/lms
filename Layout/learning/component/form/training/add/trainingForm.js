    ...
    return (
        <div>
            <div className="mt-4 grid grid-cols-4 gap-4">
                <div>
                    <label htmlFor="trainingName" className="block mb-2 text-sm font-semibold text-textSecondary">Training Name</label>
                    <input onChange={handleInput} type="trainingName" name="trainingName" id="trainingName" className="outline-gray-200 bg-gray-50 border border-gray-300 text-textSecondary sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
                <div >
                    <label htmlFor="skill" className="w-full block mb-2 text-sm font-semibold text-textSecondary">Training Description</label>
