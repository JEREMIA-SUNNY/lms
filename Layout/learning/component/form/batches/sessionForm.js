        ...
        <div date-rangepicker='true' className="mt-4 grid grid-cols-3 gap-4">
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input onChange={handleValue} name="startdate" type="datetime-local" id="startdate" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Start date start" />
                </div>
            </div>
            <div>
                ...
                <div className="relative">
                    ...
                    <input onChange={handleValue} name="enddate" type="datetime-local" id='enddate' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Start date end" />
                </div>
            </div>
        </div>
    )
