    ...
    return (
        <div className="my-2 p-2">
            <div className="mb-2 flex justify-between items-center">
                ...
                }} type="number" name="totalQuestion" id={sIndex} className="w-[210px] outline-gray-200 bg-gray-50 border border-gray-300 text-textSecondary sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5"
