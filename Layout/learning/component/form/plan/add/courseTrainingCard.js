            ...
            <Link className="p-4 rounded-lg shadow-xl bg-white  w-full" href={`/app/learning/courses/detail/${id}`}>
                <div className="w-full">
                    ...
                    <div className="relative">
                        <button onClick={() => removeSelected(item)} className="absolute top-0 right-0  m-1 w-8 h-8 justify-center text-red-400 shadow-lg bg-red-100 focus:ring-0 focus:outline-none font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                    ...
                    <div className="my-3 grid grid-cols-2 gap-2">
                        ...
                        <IconWithChip className='rounded-lg bg-primary text-white'>
                            Training
                        </IconWithChip>
                    </div>
                </div>
            </Link>
            {index < length - 1 ? <IconButton className='ml-2 bg-white shadow-lg text-primary'>
