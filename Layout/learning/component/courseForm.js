        ...
        <div className="w-full">
            <div className="mt-4 grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="Published" id="Published" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                ...
                <div>
                    ...
                    <input type="text" name="Endorsed" id="Endorsed" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
