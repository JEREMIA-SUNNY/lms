        ...
        <Link className="p-4 rounded-lg shadow-xl bg-white  w-full transition ease-in-out delay-0 hover:-translate-2 hover:shadow-lg hover:scale-110 duration-300 " href={`/app/learning/courses/detail/${id}`}>
            <div className="w-full">
                ...
                <div className="my-3 flex justify-between divide-x">
                    <div className="justify-center items-center rounded-lg bg-gray-100 px-1 py-1 flex text-gray-500 font-normal text-sm">
                    ...
                    <div className="justify-center items-center rounded-lg bg-gray-100 px-2 py-1 flex text-gray-500 font-normal text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-[#409a00]">
                    ...
                    <div className="mr-2 justify-center items-center rounded-lg bg-gray-100 px-2 py-1 flex text-gray-500 font-normal text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-[#409a00]">
