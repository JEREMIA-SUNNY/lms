        ...
        <Tab.Group>
            <div className="flex justify-between items-center">
                ...
                <div className="flex justify-start items-center">
                    <p className="mr-2">Vendor: <span className="text-sm text-textSecondary">{mockData?.vendorName}</span></p>
                    <p className="mr-2">Source: <span className="text-sm text-textSecondary">{mockData?.source}</span></p>
