    ...
    return (
        <Link className="h-full rounded-lg shadow-xl bg-white  w-full transition ease-in-out delay-0 hover:-translate-2 hover:shadow-lg hover:scale-110 duration-300 " href={`/app/recruitment/detail/${id}`}>
            ...
            <div className="w-full px-4 pb-4">
                <div className="mr-2 text-gray-500 flex justify-start items-center py-1">
                    ...
                    <div>
                        ...
                        <p className=" text-gray-500 text-xs">{item['Service Line']}</p>
                    </div>
                </div>
                <div className="grid grid-cols-2 text-gray-500 text-sm">
                    ...
                    <div className="mr-2 justify-start items-center py-1 flex text-gray-500 text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                ...
                <p className="text-gray-600 text-sm">Skills : {item?.Skills}</p>
